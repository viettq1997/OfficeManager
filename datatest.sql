...
INSERT INTO news(title,image,dates,contentt,id_staff) VALUES('Th??ng ??nh M? - Tri?u: Vi?t Nam ch? có 10 ngày ?? chu?n b?','image1','02/27/2019','Lãnh ??o B? Thông tin và Truy?n thông, B? Ngo?i giao và thành ph? Hà N?i ??ng ch? trì h?p báo v? công tác chu?n b? c?a Vi?t Nam cho h?i ngh? th??ng ??nh M? - Tri?u.',1);
INSERT INTO news(title,image,dates,contentt,id_staff) VALUES('N? sinh Vi?t Nam t?ng hoa Ch? t?ch Kim Jong Un: "Ông ?y ?ã nói c?m ?n và c??i r?t t??i','image3','02/27/2019','Lãnh ??o B? Thông tin và Truy?n thông, B? Ngo?i giao và thành ph? Hà N?i ??ng ch? trì h?p báo v? công tác chu?n b? c?a Vi?t Nam cho h?i ngh? th??ng ??nh M? - Tri?u.',2);
INSERT INTO news(title,image,dates,contentt,id_staff) VALUES('N? sinh Vi?t Nam t?ng hoa Ch? t?ch Kim Jong Un: "Ông ?y ?ã nói c?m ?n và c??i r?t t??i','image3','02/27/2019','Lãnh ??o B? Thông tin và Truy?n thông, B? Ngo?i giao và thành ph? Hà N?i ??ng ch? trì h?p báo v? công tác chu?n b? c?a Vi?t Nam cho h?i ngh? th??ng ??nh M? - Tri?u.',3);
